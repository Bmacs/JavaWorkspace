...
public class RhodeIslandDisplay implements Observer, DisplayElement {
    ...
    public RhodeIslandDisplay(Observable observable) {
    ...
    public void display() {
        System.out.println("Rhode Island Lotto Drawings: " + first + " " + second + " " + third + " " + fourth + " " + fifth);
    }
